...
export function AnimeNavBar({items, className, defaultActive = "Sobre"}: NavBarProps) {
  ...
  return (
    <div className="fixed top-5 left-0 right-0 z-[9999]">
      <div className="flex justify-center pt-6">
        <motion.div
          className="flex items-center gap-3 bg-ash/80 border border-ghost-pepper/20 backdrop-blur-lg py-2 px-2 rounded-full shadow-lg relative"
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  "text-ghost-pepper/70 hover:text-ghost-pepper",
                  isActive && "text-ghost-pepper"
                )}
              >
                {isActive && (
                  <motion.div
                ...
                <AnimatePresence>
                  {isHovered && !isActive && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-ghost-pepper/10 rounded-full -z-10"
                    />
                  )}
                </AnimatePresence>
