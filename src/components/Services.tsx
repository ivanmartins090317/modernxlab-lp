  ...
  const services = [
    {
      ...
      description: 'Aplicações web modernas, responsivas e de alta performance usando as tecnologias mais avançadas do mercado.',
      features: ['React/Next.js', 'TypeScript', 'Cloud Native']
    },
    {
      icon: Smartphone,
      title: 'Apps Mobile',
      description: 'Desenvolvimento de aplicativos nativos e híbridos para iOS e Android com UX excepcional.',
      features: ['React Native', 'Flutter', 'PWA']
    },
    {
      icon: Cloud,
      title: 'Soluções Cloud',
      description: 'Arquiteturas escaláveis na nuvem com foco em performance, segurança e otimização de custos.',
      features: ['AWS/Azure', 'DevOps', 'Microserviços']
    },
    {
      icon: Shield,
      title: 'Cibersegurança',
      description: 'Proteção avançada para seus sistemas, dados e processos com as melhores práticas de segurança.',
      features: ['Pentesting', 'Compliance', 'Monitoramento']
    },
    {
      icon: BarChart3,
      title: 'Data Analytics',
      description: 'Transforme dados em insights valiosos com análises avançadas e inteligência artificial.',
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            impulsionar sua empresa para o futuro digital
          </p>
        </div>
