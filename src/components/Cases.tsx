  ...
  const cases = [
    {
      ...
      company: 'TechBank',
      description: 'Plataforma completa de banking digital com IA para análise de crédito e prevenção à fraudes.',
      metrics: [
    ...
    },
    {
      ...
      company: 'ShopFlow',
      description: 'Marketplace B2B com inteligência artificial para recomendações e gestão automatizada de estoque.',
      metrics: [
    ...
    },
    {
      ...
      company: 'MedConnect',
      description: 'Sistema integrado de telemedicina com IoT para monitoramento de pacientes em tempo real.',
      metrics: [
            ...
            >
              ...
              <div className={`h-48 ${case_.image} relative overflow-hidden`}>
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-2xl font-bold mb-1">{case_.title}</h3>
                  ...
                  {case_.metrics.map((metric) => {
                    ...
                    return (
                      <div key={metric.label} className="text-center">
                        <IconComponent className="text-ghost-pepper mx-auto mb-1" size={20} />
